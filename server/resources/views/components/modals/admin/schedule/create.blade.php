<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModal" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="{{ url('/admin/schedule/store') }}" method="post" onSubmit="return double()">
      @csrf
          ...
          <div class="col-sm-12">
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <input name="start_at" type="text" class="form-control timepicker" data-time-format="H:i" required>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-12">
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <input name="end_at" type="text" class="form-control timepicker" data-time-format="H:i" required>
                  </div>
                </div>
              </div>
            </div>
